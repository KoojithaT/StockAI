  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-16">
      <div className="w-full px-4 sm:px-6 lg:px-12">
        ...
        <section className="mb-16">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">What We Do</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Why It Matters</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
        ...
        {/* Features Grid */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 text-center mb-12">What Makes Us Unique</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">AI-Powered Analysis</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Risk Management</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Real-Time Updates</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Technical Analysis</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Proven Results</h3>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        <section className="mb-16">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 text-center mb-8">Technology Stack</h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Backend & AI</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Frontend & UI</h3>
                <ul className="space-y-2 text-gray-600 dark:text-gray-300">
        ...
        <section className="mb-16">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 text-center mb-8">Our Team</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">AI Research Team</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Development Team</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Financial Experts</h3>
                <p className="text-gray-600 dark:text-gray-300">
