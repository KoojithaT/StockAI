...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="gradient-primary text-white min-h-[calc(100vh-4rem)] flex items-center py-16 dark:bg-gray-900">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Proprietary Algorithm</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Daily Recommendations</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Market Sentiment</h3>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-12">
          ...
          {loading ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[...Array(6)].map((_, index) => (
                <div key={index} className="news-card animate-pulse dark:bg-gray-800">
